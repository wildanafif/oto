...
<div class="form-group">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" required class="form-control" id="inputEmail3" name="nama"  data-container="body" data-toggle="popover" data-placement="top"data-trigger="focus"  data-content="Tuliskan nama anda dengan benar agar lebih mudah untuk ditemukan " >
    </div>
  </div>
   ...
   <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text"  id="maile" name="maile"   class="form-control" id="inputEmail3"   data-container="body" data-toggle="popover" data-placement="top"data-trigger="focus"  data-content="Tuliskan email anda dengan benar ,ini akan membantu anda dalam login tranpa harus melakukan registrasi" >
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">No Telp / HP</label>
    <div class="col-sm-10">
      <input type="text" required class="form-control" name="telp"    data-container="body" data-toggle="popover" data-placement="top"data-trigger="focus"  data-content="Masukkan Nomor telepon" >
    </div>
  </div>
   ...
   <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control"  name="pin_bb" id="inputEmail3"   data-container="body" data-toggle="popover" data-placement="top"data-trigger="focus"  data-content="Masukkan Pin BB" >
    </div>
  </div>
        ...
        .bootstrapValidator({
            ...
            fields: {
                judul_iklan: {
                    ...
                    validators: {
                        notEmpty: {
                            message: '<div class="alert alert-danger" style="width:70%;" role="alert"><h6>Judul iklan Tidak Boleh Kosong</h6></div>'
                        },
                        stringLength: {
                            min: 10,
                            
                            message: '<div class="alert alert-danger" style="width:70%;" role="alert"><h6>Judul iklan minimal 10 karakter</h6></div>'
                        },
                        /*remote: {
                            url: 'remote.php',
                ...
                kategori: {
                    validators: {
                        notEmpty: {
                            message: '<div class="alert alert-danger" style="width:70%;" role="alert"><h6>Kategori iklan Tidak Boleh Kosong</h6></div>'
                        }
                    }
                },
                deskripsi_iklan: {
                    validators: {
                         notEmpty: {
                            message: '<div class="alert alert-danger" style="width:70%;" role="alert"><h6>Deskripsi iklan Tidak Boleh Kosong</h6></div>'
                        },
                        stringLength: {
                            min: 20,
                            
                            message: '<div class="alert alert-danger" style="width:70%;" role="alert"><h6>Deskripsi iklan minimal 20 karakter</h6></div>'
                        },
                    }
                },
                harga: {
                    validators: {
                       notEmpty: {
                            message: '<div class="alert alert-danger" style="width:70%;" role="alert"><h6>Harga Tidak Boleh Kosong</h6></div>'
                        }
                ...
                provinsi: {
                    validators: {
                         notEmpty: {
                            message: '<div class="alert alert-danger" style="width:70%;" role="alert"><h6>Provinsi Tidak Boleh Kosong</h6></div>'
                        }
                ...
                nama: {
                    validators: {
                         notEmpty: {
                            message: '<div class="alert alert-danger" style="width:70%;" role="alert"><h6>Nama Tidak Boleh Kosong</h6></div>'
                        }
                ...
                telp: {
                    validators: {
                         notEmpty: {
                            message: '<div class="alert alert-danger" style="width:70%;" role="alert"><h6>Telepon Tidak Boleh Kosong</h6></div>'
                        },
                         digits: {
                            message: '<div class="alert alert-danger" style="width:70%;" role="alert"><h6>Format salah</h6></div>'
                        }
                ...
                pin_bb: {
                    validators: {
                        stringLength: {
                            ...
                            message: '<div class="alert alert-danger" style="width:70%;" role="alert"><h6>Format Pin min 8 karakter Max 8 karakter</h6></div>'
                        },
            ...
            maile: {
                ...
                validators: {
                   notEmpty: {
                            message: '<div class="alert alert-danger" style="width:70%;" role="alert"><h6>Email Tidak Boleh Kosong</h6></div>'
                        },
                    emailAddress: {
                        message: '<div class="alert alert-danger" style="width:70%;" role="alert"><h6>Format email salah</h6></div>'
                    }
                }
            },
            'acc': {
                validators: {
                    notEmpty: {
                        message: '<div class="alert alert-danger" style="width:70%;" role="alert"><h6>Silahkan Centang persetujuan Untuk proses iklan</h6></div>'
                    }
                }
            }
