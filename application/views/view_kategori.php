...
<div class="panel panel-default">
            ...
            <div class="panel-body">
             ...
             <div class="col-md-4"><a href="" onClick="addProv('jawa timur')"   disabled style=";"><i><b>jawa timur</b></i> </a></div>
             <div class="col-md-4"><a href="" onClick="addProv('jawa barat')"   disabled style=";"><i><b>jawa barat</b></i> </a></div>
               </div>
          </div>
         </div>
        </div> 
...
<div style="margin-bottom:20px;" ></div>
        ...
        <div class="container">
          <h2 style="margin-bottom:25px;">Kategori : <?php echo $title_kategori; ?></h2>
         <div class="">
       ...
       <li role="presentation" <?php if (isset($tab_active)) {
        if ($tab_active=="semua") { ?>
          class="active"
        <?php }
         # code...
       } ?>><a href="<?=base_url()?><?php echo $title_kategori ?>" >Semua Iklan Dari Kategori <?php echo $title_kategori ?></a></li>

        <?php foreach ($sub_kategori as $key ) {
        $sub=str_replace(" ", "-", $key->nama_sub_kategori);
          ?>
            <li  <?php if ($tab_active==$key->nama_sub_kategori) {
              echo 'class="active"';
            } ?> ><a href="<?=base_url()?><?php echo $title_kategori.'/sub_kategori/'.$sub; ?>" ><?php echo $key->nama_sub_kategori; ?></a></li>
          
        <?php } ?>
        <div class="hilang"><li style="float:right;"><strong>Category Title</strong>
        <div class="btn-group">
