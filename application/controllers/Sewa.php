...
class Sewa extends CI_Controller {
    ...
    function __construct() {
        ...
        $config['base_url'] = base_url()."Sewa/page";
        //jumlah total data
          $config['total_rows'] = $this->model_iklan->TotalPosting_kategori("Sewa");
...
// mengambil data per halaman
        $data['produk'] = $this->model_iklan->TampilPosting_kategori($config['per_page'], $this->uri->segment(3) , "Sewa");
// kirim data dan hasil paging ke file application/views/v_produk.php
        ...
        //inisisalisasi
        $data['title_kategori']="Sewa";
        $kategori=$this->model_iklan->query_for_control("SELECT * From kategori where nama_kategori='Sewa'");
...
// kirim data dan hasil paging ke file application/views/v_produk.php
    ...
    function sub_kategori(){
        ...
        $where= "sub_kategori='".$sub_kategori."'";
            ...
            $config['base_url'] = base_url()."Sewa/page_sub_c/".$segment_data."/";
            //jumlah total data
    ...
    // kirim data dan hasil paging ke file application/views/v_produk.php
        ...
        $data['title_kategori']="Sewa";
        $kategori=$this->model_global->query_for_control("SELECT * From kategori where nama_kategori='Sewa'");
