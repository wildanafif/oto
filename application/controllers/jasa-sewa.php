...
class Jasa_sewa extends CI_Controller {
    ...
    function __construct() {
        ...
        $config['base_url'] = base_url()."Jasa-Sewa/page";
        //jumlah total data
          $config['total_rows'] = $this->model_iklan->TotalPosting_kategori("Jasa & Sewa");
...
// mengambil data per halaman
        $data['produk'] = $this->model_iklan->TampilPosting_kategori($config['per_page'], $this->uri->segment(3) , "Jasa & Sewa");
// kirim data dan hasil paging ke file application/views/v_produk.php
        ...
        //inisisalisasi
        $data['title_kategori']="Jasa-Sewa";
        $kategori=$this->model_iklan->query_for_control("SELECT * From kategori where nama_kategori='Jasa & Sewa'");
...
// kirim data dan hasil paging ke file application/views/v_produk.php
        ...
        $data['title']=  "Otomotif Store";
        //inisisalisasi
        $data['title_kategori']="Mobil";
        $kategori=$this->model_iklan->query_for_control("SELECT * From kategori where nama_kategori='Mobil'");
        $data['sub_kategori']=$this->model_iklan->query_getAll("SELECT * From sub_kategori where id_kategori=".$kategori['id_kategori']);
        $data['tab_active']='semua';
        //akhir inisial
         if (isset($_SESSION['id_user'])) {
    ...
    function sub_kategori(){
        ...
        $where= "sub_kategori='".$sub_kategori."'";
            ...
            $config['base_url'] = base_url()."Mobil/page_sub_c/".$segment_data."/";
            //jumlah total data
    ...
    // kirim data dan hasil paging ke file application/views/v_produk.php
        ...
        $data['title_kategori']="Mobil";
        $kategori=$this->model_global->query_for_control("SELECT * From kategori where nama_kategori='Mobil'");
